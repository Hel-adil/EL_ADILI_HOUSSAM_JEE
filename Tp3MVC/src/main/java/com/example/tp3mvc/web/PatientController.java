package com.example.tp3mvc.web;
...
public class PatientController {
    ...
    @PostMapping("/save")
    public String save(Model model, @Valid Patient patient , BindingResult result , int page, String keyword){
        if(result.hasErrors()) return "formpatients";
